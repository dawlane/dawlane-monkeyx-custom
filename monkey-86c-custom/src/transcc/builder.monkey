...
Class Builder
	...
	Method Make:Void()
		...
		' Dawlane Modified for Linux MinGw Cross-Compiler: Make sure that the parser is set to winnt and not the native OS
		If HostOS="linux" Or HostOS="macos"
			If tcc.opt_mingw32cross And ( tcc.target.system = "glfw" Or tcc.target.system = "stdcpp") Then
				Print "....Using MinGW32 Cross Compiler...."
				ENV_HOST="winnt"
			Else
				ENV_HOST=HostOS
			Endif
